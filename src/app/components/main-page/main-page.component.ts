...
export class MainPageComponent implements OnInit {
  ...
  questionsAndAnswers = [
    ...
    new Questions("If my VPN connections fails, when I connect my Shoretel doesn’t reconnect, is there anything I can do to fix it?",
                  "<li>Click the up arrow near the clock</li><br/><li>Right click the Shoretel icon</li><br/><li>Left click exit The Shoretel icon should then disappear</li><br/><li>Reopen Shoretel and it should now show a blue phone again</li><br/><img src=assets/images/exit-shoretel.PNG alt=Exit Shoretel class = responsive-image>"),
    new Questions("How can I speed up the log in process?",
                  "You can edit the connection by clicking the cog in the top right as shown below.<br/><img src=assets/images/forticlient-login.png alt=Forticlient Login class = responsive-image><br/>You will then be presented with the below screen where you will select ‘save login’ next to authentication and input your username.<br/><img src=assets/images/edit-vpn-screen.png alt=Exit Shoretel class = responsive-image>"),
